...
public class EnemyController : MonoBehaviour
{
    ...
    [SerializeField] float movingTime = 1f, respawnMovingTime = 5f, horizontalSpace = 1f, verticalSpace = 1f, respawnHeight = 5f;
    ...
    private void setRowActive(bool active, GameObject[] enemies)
    {
        for (int i = 0; i < enemies.Length; i++)
        {
            enemies[i].GetComponent<Enemy>().setActive(active);
        }
    }
